...
# sciezka = input('Podaj sciezke katalogu do odczytania: ')
# os.chdir(sciezka)
...
# def zmien():
#     while True:
#         pytanie = input('Czy mam zmienic katalog? ')
#         if pytanie == 'yes':
#             sciezka = input('Podaj sciezke katalogu do odczytania: ')
#             os.chdir(sciezka)
#             zawartosc = os.listdir('.')
...
# os.chdir("Dokument")
# file1 = open('Lab1.doc', 'w', encoding='utf-8')
# file1.close()
# file2 = open('Lab2.doc', 'w', encoding='utf-8')
# file2.close()
# file3 = open('Lab3.doc', 'w', encoding='utf-8')
# file3.close()
# print(os.listdir('.'))
#
...
# os.chdir('C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\StudentDoc')
# zawartosc = os.listdir('.')
# print(zawartosc)
# rozmiar_pliku = os.path.getsize('C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\StudentDoc\doc1.txt')
# print(rozmiar_pliku)
# rozmiar_pliku = os.path.getsize('C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\StudentDoc\doc2.txt')
# print(rozmiar_pliku)
# os.chdir('C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\StudentObrazy')
# zawartosc = os.listdir('.')
# print(zawartosc)
# rozmiar_pliku = os.path.getsize('C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\StudentObrazy\obr1.jpg')
# print(rozmiar_pliku)
# rozmiar_pliku = os.path.getsize('C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\StudentObrazy\obr2.jpg')
# print(rozmiar_pliku)
...
# os.makedirs('PawcioMiecz')
# os.rename('C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\PawcioMiecz','C:\\Users\\Student s1016\PycharmProjects\pythonProjectMieczkowski\LabA.B\PawcioMieczNOWY')
...
# lista3 = ['uhhhhhh']
#
# file = open('listy.txt', 'wb')
# pickle.dump((lista1,lista2,lista3),file)
# file.close()
#
# del lista1, lista2, lista3
# file2 = open('listy.txt', 'rb')
# odczytanie = pickle.load(file2)
# print(odczytanie[0])
# print(odczytanie[1])
# print(odczytanie[2])
...
# file = open('liczba.txt','wb')
# liczba = pack('l',123456789)
# file.write(liczba)
# file.close()
#
# file2 = open('liczba.txt','rb')
# print(unpack('l',file2.read()))
# file2.close()
